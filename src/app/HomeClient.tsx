    ...
    <main className="fw-page" style={styles.page}>
      ...
      <section className="fw-grid" style={styles.grid}>
        ...
        >
          ...
          <div
            className="fw-goal-editor"
            style={styles.goalEditor}
          >
            <input
              aria-label="오늘 목표 분"
              type="number"
      ...
      >
        ...
        <p style={styles.sub}>
          휴대폰 브라우저에서{" "}
          <b>홈 화면에 추가</b>하면 앱 아이콘으로
          바로 실행할 수 있어요. 설치가 지원되는
          브라우저에서는 아래 버튼이 나타납니다.
        </p>
...
const styles: Record<string, CSSProperties> = {
  ...
  balance: {
    background:
      "linear-gradient(135deg,#f0efff,#fff)",
  },
  ...
  fill: {
    height: "100%",
    background:
      "linear-gradient(90deg,#6c63ff,#8b84ff)",
    borderRadius: 99,
  },
